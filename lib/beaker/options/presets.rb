  ...
  module Options
    ...
    class Presets
      ...
      def format_found_env_vars(found_env_vars)
        ...
        if found_env_vars.key?(:color)
          no_color_val = ENV['NO_COLOR']
          beaker_color_val = ENV['BEAKER_color']

          if no_color_val && !no_color_val.empty?
            found_env_vars[:color] = false
          elsif beaker_color_val && !beaker_color_val.empty?
